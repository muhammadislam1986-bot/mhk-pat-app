...
function renderLabel(){
  ...
  $('labelArea').innerHTML = buildLabelHTML(data, true) + `<div class="labelPreviewNote noprint">Tip: for Bluetooth and different printers, use Save Label or Share Label.</div>`;
}
